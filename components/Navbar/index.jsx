            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
                    ...
                    <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0 ">
                        ...
                        <a
                            href="#"
                            className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-base font-medium text-white bg-primary dark:shadow-md dark:shadow-primary dark:hover:shadow-lg dark:hover:shadow-primary hover:bg-primary"
                        >
                            Contact us
                        </a>
                    </div>
