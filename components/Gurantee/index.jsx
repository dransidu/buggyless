        ...
        <div className="dark:bg-gray-900 pb-48">
            <div className="max-w-6xl mx-auto px-5 flex flex-col items-center sm:flex sm:flex-row">
                <div className="sm:w-7/12">
                    ...
                    <a
                        href="#"
                        className="mt-5 text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-xl text-base px-6 py-2.5 text-center md:mr-5 mb-3 md:mb-0 inline-flex items-center justify-center"
                    >
                        What we do
                    </a>
                </div>
