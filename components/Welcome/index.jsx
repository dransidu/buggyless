    ...
    return (
        <div className="max-w-7xl mx-auto">
            <div className="flex flex-col sm:flex sm:flex-row p-6 items-center">
                <div className="left">
                    <p className="text-center sm:text-left text-gray-600 text-base">
                        Top Web and Mobile Apps Development Company
                    </p>
                    <p className="text-center sm:text-left text-gray-900 text-5xl sm:text-6xl font-extrabold mt-5 sm:leading-idleSize">
                        Your Trusted <br></br> Development <br></br>Partner
                    </p>
                    <p className="text-center sm:text-left mt-5 mb-10 text-gray-600 ">
                    ...
                    <a
                        href="#"
                        className="text-center sm:text-left px-8 py-4 bg-primary mt-5 font-medium text-white rounded-lg shadow-md shadow-primary hover:shadow-lg "
                    >
                        What we do
                    </a>
                </div>
